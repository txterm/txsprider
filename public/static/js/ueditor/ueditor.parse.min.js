...
!function () {
    !function () {
            ...
            removeLastbs: function (a) {
                ...
                if (f)for (; f--;)if (c = e[f], a.removeEventListener)a.removeEventListener(c, d, !1); else {
                    ...
                    if (d._d && d._d[g]) {
                        ...
                        -1 != i && d._d.els.splice(i, 1), 0 == d._d.els.length && delete d._d[g]
                    }
                }
            }, loadFile: function () {
                function a(a, c) {
        ...
        if (h.length) {
            ...
            a.each(h, function (d) {
                /\bsortEnabled\b/.test(d.className) && a.on(d, "click", function (d) {
                    ...
                    -1 != j && (c(i, j, f.tableSortCompareFn || k), e(i))
                })
            })
        }
        ...
        function l(a) {
            ...
            if ("1" != f.dataFormat) {
                for (var g = 0, h = e.length; h > g; g++)for (var i = 0, j = e[g].length; j > i; i++)d[i] || (d[i] = []), d[i][g] = e[g][i];
                e = d
            }
