...
$(function () {
    ...
    $("#task-content-inner").on("click", ".macro-component-tabclose", function () {
...
var task_item_tpl = '<li class="macro-component-tabitem">' +
    '<a class="macro-tabs-item-text"></a>' +
    '<span class="macro-component-tabclose" href="javascript:void(0)" title="点击关闭标签"><span></span><b class="macro-component-tabclose-icon">×</b></span>' +
    '</li>';
